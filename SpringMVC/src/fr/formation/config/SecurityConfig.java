...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Override
    protected void configure(AuthenticationManagerBuilder auth)				// a mettre en commentaire pour pouvoir rentrer sans etre dans la base
	    throws Exception {
	auth.userDetailsService(loginService);
    }

    @Bean
    public PasswordEncoder passwordEncoder() {								// a mettre en commentaire pour pouvoir rentrer sans etre dans la base
